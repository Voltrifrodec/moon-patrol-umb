...
#* Player
(PLAYER_WIDTH, PLAYER_HEIGHT) = (100, 75)
class Vehicle:
    def __init__(self):
        self.w = PLAYER_WIDTH
        ...
        # self.rect = pygame.Rect(0, self.surface.get_height() - self.h - ground_surface.get_height(), self.w, self.h)
        self.rect = pygame.Rect(0, self.surface.get_height() - self.h - ground_surface.get_height(), self.w, self.h)
        self.image = pygame.transform.scale(pygame.image.load('assets/images/Player-final.png'), self.rect.size)
...
class Obstacle:
    def __init__(self):
        ...
        self.rect = pygame.Rect(self.surface.get_width(), background_surface.get_height() - 5 - ground_surface.get_height(), self.w, self.h)
